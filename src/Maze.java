...
public class Maze {
    ...
    public static void print(int[][] labirint, int a, int b, int inc,boolean flag) {
        System.out.println("(x, y)= " + a + ","+ b + " flag = " + flag);
    ...
    public static  boolean fill (int[][] labirint, int a, int b, int inc,boolean flag){
        //print(labirint,a,b,inc,flag);
        if (flag == true) {
            int t=0;
            return  flag;
        }
      ...
      if (down & labirint[a+1][b] >=0){
            labirint[a][b] = inc;
            print(labirint,a,b,inc,flag);
            flag = fill(labirint,a+1,b,inc+1,flag);};
        if (right & labirint[a][b+1] >=0){
            labirint[a][b] = inc;
            print(labirint,a,b,inc,flag);
            flag = fill(labirint,a,b+1,inc+1,flag);};
  ...
  /*      if ((labirint[a+1][b] >=0) & (labirint[a+1][b]!=inc) & (labirint[a+1][b]!=-1)){
    ...
    public static void main(String[] args) {
        ...
        boolean flag=false;
        boolean flag1=false;
        flag1 = fill(labirint,1,2,1, flag);
        //print(labirint,a,b,inc,flag);
        // System.out.println("---------------------------------////////////---------------------");
    }
